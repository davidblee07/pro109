    ...
    if results.multi_hand_landmarks:
        for hand_landmark in results.multi_hand_landmarks:
            ...
            for tip in finger_tips:
                ...
                #escrevendo a condição para verificar se o dedo está dobrado, ou seja,
                #verificar se o valor inicial da ponta do dedo é menor que a posição inicial do dedo que é o marco interno para o dedo indicador    
            ...
            if all(finger_fold_status):
             ...
             pyautogui.screenshot("straight_to_disks.png")
